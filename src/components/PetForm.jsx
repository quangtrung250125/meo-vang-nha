...
const PetForm = ({ initialData, onSave, onCancel, isSaving }) => {
  ...
  const handleSubmit = () => {
    ...
    const needsSpecialCare = petData.health.medicalCondition.trim() !== '' || petData.health.medication.trim() !== '';
    const finalData = { ...petData, isSpecialCare: needsSpecialCare };
